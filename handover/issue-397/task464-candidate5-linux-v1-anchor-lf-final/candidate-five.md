...
- Driver shell SHA-256: `f811dbd09b73c5aa6a1a426773a0f27c636a9a66dd3e16b077f58204e1cf6cf6`
...
- Fresh extraction boundary: extract `/execution_driver/shell` from this exact Markdown/JSON pair, require shell SHA-256 `f811dbd09b73c5aa6a1a426773a0f27c636a9a66dd3e16b077f58204e1cf6cf6`, require normalized JSON identity `0005a5cd7f8d1c3d048fad6589165e00b0748b34858918bddcf7f66b64749aae`, then invoke only the freshly extracted body. Standalone `/tmp/hermternal-task409-approved-driver.sh` is stale and non-authoritative; never reuse it.
...
- Matrix identity: exact source bytes are validated with normalized SHA-256 `0005a5cd7f8d1c3d048fad6589165e00b0748b34858918bddcf7f66b64749aae`; after root creation they are read once through `O_NOFOLLOW`, written with `O_CREAT|O_EXCL` at mode `0600` to `$REPLAY_ROOT/matrix.snapshot.json`, and every mutation boundary verifies device/inode/size/realpath.
- Byte-exact Markdown extraction: raw bytes, canonical section heading, first exact ` ```bash\n ` opening, first exact ` ``` ` closing, and no trimming or newline normalization; body and JSON shell are `289339` bytes, SHA-256 `f811dbd09b73c5aa6a1a426773a0f27c636a9a66dd3e16b077f58204e1cf6cf6`, terminal byte `0a`.
...
readonly MARKDOWN=/tmp/hermternal-397-integrate/handover/issue-397/task464-candidate5-linux-v1-anchor-lf-final/candidate-five.md
readonly MATRIX_SOURCE=/tmp/hermternal-397-integrate/handover/issue-397/task464-candidate5-linux-v1-anchor-lf-final/candidate-five.json
MATRIX="$MATRIX_SOURCE"
readonly MATRIX_EXPECTED_BINDING_SHA256='0005a5cd7f8d1c3d048fad6589165e00b0748b34858918bddcf7f66b64749aae'
MATRIX_BOUND=0
...
| JSON companion | `/tmp/hermternal-397-integrate/handover/issue-397/task464-candidate5-linux-v1-anchor-lf-final/candidate-five.json` |
| Driver schema | `hermternal.task409.execution-driver.v1` |
| Driver shell SHA-256 | `f811dbd09b73c5aa6a1a426773a0f27c636a9a66dd3e16b077f58204e1cf6cf6` |
