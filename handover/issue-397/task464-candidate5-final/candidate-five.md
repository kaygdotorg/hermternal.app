...
- Driver shell SHA-256: `f7d5adfc9178431942d62948ffaf1953a2273bdec002661def9d0e80ffc34676`
...
- Fresh extraction boundary: extract `/execution_driver/shell` from this exact Markdown/JSON pair, require shell SHA-256 `f7d5adfc9178431942d62948ffaf1953a2273bdec002661def9d0e80ffc34676`, require normalized JSON identity `56e75d58f10047ce19f5ba4d31ebbb949655adf71f3b90f62d835cb36a395e50`, then invoke only the freshly extracted body. Standalone `/private/tmp/hermternal-task409-approved-driver.sh` is stale and non-authoritative; never reuse it.
...
- Matrix identity: exact source bytes are validated with normalized SHA-256 `56e75d58f10047ce19f5ba4d31ebbb949655adf71f3b90f62d835cb36a395e50`; after root creation they are read once through `O_NOFOLLOW`, written with `O_CREAT|O_EXCL` at mode `0600` to `$REPLAY_ROOT/matrix.snapshot.json`, and every mutation boundary verifies device/inode/size/realpath.
- Byte-exact Markdown extraction: raw bytes, canonical section heading, first exact ` ```bash\n ` opening, first exact ` ``` ` closing, and no trimming or newline normalization; body and JSON shell are `289369` bytes, SHA-256 `f7d5adfc9178431942d62948ffaf1953a2273bdec002661def9d0e80ffc34676`, terminal byte `0a`.
...
readonly MARKDOWN=/home/kayg/Developer/hermternal/handover/issue-397/task464-candidate5-final/candidate-five.md
readonly MATRIX_SOURCE=/home/kayg/Developer/hermternal/handover/issue-397/task464-candidate5-final/candidate-five.json
MATRIX="$MATRIX_SOURCE"
readonly MATRIX_EXPECTED_BINDING_SHA256='56e75d58f10047ce19f5ba4d31ebbb949655adf71f3b90f62d835cb36a395e50'
MATRIX_BOUND=0
...
| JSON companion | `/home/kayg/Developer/hermternal/handover/issue-397/task464-candidate5-final/candidate-five.json` |
| Driver schema | `hermternal.task409.execution-driver.v1` |
| Driver shell SHA-256 | `f7d5adfc9178431942d62948ffaf1953a2273bdec002661def9d0e80ffc34676` |
