...
- Driver shell SHA-256: `d3896b3fe23e66b8fe4480c10f8dd91602c2a5364e5806ea2a8c840c803f8119`
...
- Fresh extraction boundary: extract `/execution_driver/shell` from this exact Markdown/JSON pair, require shell SHA-256 `d3896b3fe23e66b8fe4480c10f8dd91602c2a5364e5806ea2a8c840c803f8119`, require normalized JSON identity `f5b77b8764c303e1aceb96f82b12623c575a4f0d20eb6cc67586e67454399b99`, then invoke only the freshly extracted body. Standalone `/private/tmp/hermternal-task409-approved-driver.sh` is stale and non-authoritative; never reuse it.
...
- Matrix identity: exact source bytes are validated with normalized SHA-256 `f5b77b8764c303e1aceb96f82b12623c575a4f0d20eb6cc67586e67454399b99`; after root creation they are read once through `O_NOFOLLOW`, written with `O_CREAT|O_EXCL` at mode `0600` to `$REPLAY_ROOT/matrix.snapshot.json`, and every mutation boundary verifies device/inode/size/realpath.
- Byte-exact Markdown extraction: raw bytes, canonical section heading, first exact ` ```bash\n ` opening, first exact ` ``` ` closing, and no trimming or newline normalization; body and JSON shell are `199434` bytes, SHA-256 `d3896b3fe23e66b8fe4480c10f8dd91602c2a5364e5806ea2a8c840c803f8119`, terminal byte `0a`.
...
| JSON companion | `/private/tmp/task464-test32-json.json` |
| Driver schema | `hermternal.task409.execution-driver.v1` |
| Driver shell SHA-256 | `d3896b3fe23e66b8fe4480c10f8dd91602c2a5364e5806ea2a8c840c803f8119` |
...
| Swift source SHA | `221620c04bb051f2597c52bdeb16ccc55c5b2e9c` |
| Shell body bytes | `199434` |
| Shell body lines | `4164` |
