...
def run_gates(authority: Authority, run: Callable[..., subprocess.CompletedProcess[bytes]]) -> dict[str, Any]:
    ...
    return {"schema": "hermternal.issue-397.offline-gates.v1", "status": "passed", "offline": True, "credentials": "not-used", "network": "not-used", "repository": str(authority.repository), "final_head": authority.final_head, "main_unchanged": MAIN_COMMIT, "dev_target": authority.final_head, "gates": results}
