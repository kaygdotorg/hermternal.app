...
- Driver shell SHA-256: `6b80b817dfabef66ef2ed2da4200e0e9e72aabd10b71de3edcfc5268869fbce1`
...
- Fresh extraction boundary: extract `/execution_driver/shell` from this exact Markdown/JSON pair, require shell SHA-256 `6b80b817dfabef66ef2ed2da4200e0e9e72aabd10b71de3edcfc5268869fbce1`, require normalized JSON identity `da6f41dac09c07d1fc0e08cfa3e65d517041b1919d36e86be26e2ec211bfe88d`, then invoke only the freshly extracted body. Standalone `/tmp/hermternal-task409-approved-driver.sh` is stale and non-authoritative; never reuse it.
...
- Matrix identity: exact source bytes are validated with normalized SHA-256 `da6f41dac09c07d1fc0e08cfa3e65d517041b1919d36e86be26e2ec211bfe88d`; after root creation they are read once through `O_NOFOLLOW`, written with `O_CREAT|O_EXCL` at mode `0600` to `$REPLAY_ROOT/matrix.snapshot.json`, and every mutation boundary verifies device/inode/size/realpath.
- Byte-exact Markdown extraction: raw bytes, canonical section heading, first exact ` ```bash\n ` opening, first exact ` ``` ` closing, and no trimming or newline normalization; body and JSON shell are `289987` bytes, SHA-256 `6b80b817dfabef66ef2ed2da4200e0e9e72aabd10b71de3edcfc5268869fbce1`, terminal byte `0a`.
...
readonly MARKDOWN=/tmp/hermternal-397-integrate/handover/issue-397/task464-candidate5-linux-v2-parent-binding-final/candidate-five.md
readonly MATRIX_SOURCE=/tmp/hermternal-397-integrate/handover/issue-397/task464-candidate5-linux-v2-parent-binding-final/candidate-five.json
MATRIX="$MATRIX_SOURCE"
readonly MATRIX_EXPECTED_BINDING_SHA256='da6f41dac09c07d1fc0e08cfa3e65d517041b1919d36e86be26e2ec211bfe88d'
MATRIX_BOUND=0
...
| JSON companion | `/tmp/hermternal-397-integrate/handover/issue-397/task464-candidate5-linux-v2-parent-binding-final/candidate-five.json` |
| Driver schema | `hermternal.task409.execution-driver.v1` |
| Driver shell SHA-256 | `6b80b817dfabef66ef2ed2da4200e0e9e72aabd10b71de3edcfc5268869fbce1` |
...
| Swift source SHA | `221620c04bb051f2597c52bdeb16ccc55c5b2e9c` |
| Shell body bytes | `289987` |
| Shell body lines | `5985` |
