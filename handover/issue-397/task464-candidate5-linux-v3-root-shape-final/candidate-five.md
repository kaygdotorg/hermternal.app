...
- Driver shell SHA-256: `a0c4f54e8d2e7d404327c12316dee67bb3e498f1e610851b6f58eb8e32226c32`
...
- Fresh extraction boundary: extract `/execution_driver/shell` from this exact Markdown/JSON pair, require shell SHA-256 `a0c4f54e8d2e7d404327c12316dee67bb3e498f1e610851b6f58eb8e32226c32`, require normalized JSON identity `63a626f441c8bed83459ad3cb69f98503b801f0c07518f9c4a29566aee2fc7b5`, then invoke only the freshly extracted body. Standalone `/tmp/hermternal-task409-approved-driver.sh` is stale and non-authoritative; never reuse it.
...
- Matrix identity: exact source bytes are validated with normalized SHA-256 `63a626f441c8bed83459ad3cb69f98503b801f0c07518f9c4a29566aee2fc7b5`; after root creation they are read once through `O_NOFOLLOW`, written with `O_CREAT|O_EXCL` at mode `0600` to `$REPLAY_ROOT/matrix.snapshot.json`, and every mutation boundary verifies device/inode/size/realpath.
- Byte-exact Markdown extraction: raw bytes, canonical section heading, first exact ` ```bash\n ` opening, first exact ` ``` ` closing, and no trimming or newline normalization; body and JSON shell are `290406` bytes, SHA-256 `a0c4f54e8d2e7d404327c12316dee67bb3e498f1e610851b6f58eb8e32226c32`, terminal byte `0a`.
...
readonly MARKDOWN=/tmp/hermternal-397-integrate/handover/issue-397/task464-candidate5-linux-v3-root-shape-final/candidate-five.md
readonly MATRIX_SOURCE=/tmp/hermternal-397-integrate/handover/issue-397/task464-candidate5-linux-v3-root-shape-final/candidate-five.json
MATRIX="$MATRIX_SOURCE"
readonly MATRIX_EXPECTED_BINDING_SHA256='63a626f441c8bed83459ad3cb69f98503b801f0c07518f9c4a29566aee2fc7b5'
MATRIX_BOUND=0
...
def take(n):
    ...
    return value
clean_parent = take(5); clean_root_id = take(5); clean_root_real = take(1); clean_child = take(5)
...
| JSON companion | `/tmp/hermternal-397-integrate/handover/issue-397/task464-candidate5-linux-v3-root-shape-final/candidate-five.json` |
| Driver schema | `hermternal.task409.execution-driver.v1` |
| Driver shell SHA-256 | `a0c4f54e8d2e7d404327c12316dee67bb3e498f1e610851b6f58eb8e32226c32` |
...
| Swift source SHA | `221620c04bb051f2597c52bdeb16ccc55c5b2e9c` |
| Shell body bytes | `290406` |
| Shell body lines | `5992` |
