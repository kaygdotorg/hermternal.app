...
four-ref trusted bundle measured a 37,716,297-byte macOS fresh-clone pack, so the
40 MiB per-pack cap retains 4,226,743 bytes of headroom. A seeded clone retains
