...
/**
 * Keep the synthetic benchmark profile reviewed and immutable. A different
 * runtime or host requires a new evidence review instead of mutable metadata.
 */
...
export function capturePtyBenchmarkProvenance(
  ...
  if (
    ...
    environment.runtime.hostNode !==
      REVIEWED_PTY_BENCHMARK_ENVIRONMENT.runtime.hostNode ||
