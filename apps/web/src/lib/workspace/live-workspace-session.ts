...
export class LiveWorkspaceSession {
  ...
  private async openSession(
    ...
    // The terminal coordinator follows the canonical captured ID, not a raw REST wrapper.
    await this.syncCoordinatorSession(operation.generation, capturedSessionId, operation.signal);
  }
